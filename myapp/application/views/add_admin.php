...
<body>
	<nav class="navbar navbar-expand-md">
		...
		<div class="collapse navbar-collapse" id="main-navigation">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a class="nav-link" href="#">Add Admins</a>
				</li>
				<li class="nav-item">
	...
	<div class="form_reg clearfix">
			...
			<form method="post">
			<fieldset><legend>Admin Registration</legend>
				...
				<label for="field3"><span>Phone <span class="required">*</span></span><input type="text" class="input-field" name="telephone" value="" /></label>
				<label for="field3"><span>Address <span class="required">*</span></span><input type="text" class="input-field" name="address" value="" /></label>
