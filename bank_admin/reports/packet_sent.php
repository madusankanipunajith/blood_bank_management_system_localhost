...
<?php
    ...
    $sql="SELECT a.ID AS ID,a.ReceiverID AS ReceiverID, a.Type AS Type, a.Amount AS Amount, a.Dates AS Dates, b.Name AS Name, b.District AS District FROM blood_bank_request a INNER JOIN blood_bank_hospital b ON a.SenderID=b.HospitalID WHERE ReceiverID='$bank_id'";
