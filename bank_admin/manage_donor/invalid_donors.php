...
<body class="">
	...
	<div class="container-row donor">
        ...
        <div class="main">
            <div class="topic">
                 <div class="form-style-2-heading"><div align="center">Rejected Donors</div><?php echo"<input class=\"search\" type=\"text\" id=\"search\" placeholder=\"Search bar\">";?></div>
            </div>
